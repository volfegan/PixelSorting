...
void draw() {
  ...
  println("Merge sort: " +String.format("%.2f", frameRate) + "frameRate\t division: " 
  ...
  if (!stackcalls.isEmpty() && division < (dummy.pixels.length-1)) text("Merge sort: " +String.format("%.2f", frameRate) + 
      " frameRate / division: " + division + " / steps: "+ stackcalls.size() + " / sort by " + sortPixelMethod, 0, 18);
  else {
